...
builder.Services.AddSwaggerGen(c =>
{
    ...
    { 
        Title = "TekProvider Support API", 
        Version = "v1",
        Description = "API de Soporte y Tickets para TekProvider"
    });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "TekProvider Support API v1");

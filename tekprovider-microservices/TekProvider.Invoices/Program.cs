...
builder.Services.AddSwaggerGen(c =>
{
    ...
    { 
        Title = "TekProvider Invoices API", 
        Version = "v1",
        Description = "API de Gestión de Facturas para TekProvider"
    });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "TekProvider Invoices API v1");

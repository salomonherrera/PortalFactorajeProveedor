...
builder.Services.AddSwaggerGen(c =>
{
    ...
    { 
        Title = "TekProvider Factoring API", 
        Version = "v1",
        Description = "API de Gestión de Factoraje para TekProvider"
    });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "TekProvider Factoring API v1");
